...
*/
$config['tables']['users']           = 'employee';
$config['tables']['groups']          = 'groups';
$config['tables']['users_groups']    = 'employee_groups';
 ...
 */
$config['site_title']                 = "Attendace and Payroll Managment System";       // Site Title, example.com
...
$config['user_expire']                = 86500000;               // How long to remember the user (seconds). Set to zero for no expiration
