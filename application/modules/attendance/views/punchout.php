            ...
            <div class="row">
                <div class="widget">
                    <div class="widget-header bordered-bottom bordered-blue">
                        <span class="widget-caption">Punch out attendance</span>
                    </div>
                    <div class="widget-body flat radius-bordered">
                        <div id="registration-form">
                            ...
                            <div class="table-toolbar">
                                ...
                                <button class="btn btn-small btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Punch Logout Time <i class="fa fa-plus"></i></button>                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="" for="logout_time">Punch out Time</label>
