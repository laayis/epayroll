...
<div class="centercontent tables">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">RBAC: Add New Role</h1>
            <span class="pagedesc">Add information/name and permissions of a role</span>
        ...
        <div id="contentwrapper" class="contentwrapper withrightpanel">
			...
			?>
                ...
                <?php	echo form_open('rbac/addrole') ?>
                <p>
                <label for="roleName" style="font-weight: bold">Role Name: </label> <input type="text" name="roleName" id="roleName" value="" class="smallinput" required />
                </p>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
		        	...
		        	?>  
                        <tr <?php //echo $class;?>>
                            ...
                            <td class="center">
                            <?php echo "<input type=\"radio\" name=\"perm_" . $v['ID'] . "\" id=\"perm_" . $v['ID'] . "_1\" value=\"1\"";
            ...
            echo " />";
		                ...
		                <?php } else { ?>
		                <tr>
							<td colspan="4" style="text-align:center; color:#F00"> <strong>Sorry No Record(s) Found </strong></td>
						  </tr>
		                <?php } ?>
